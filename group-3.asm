...
INTRO2 DB '         ****************        GROUP 3 MIC PROJECT      *************** $',10,13
...
CS_MALE DB 10,13,' 1    CASUAL SHIRT(MALE)        150 INR $'
                        
FS_MALE DB 10,13,' 2    FORMAL SHIRT(MALE)        140 INR $'
                     
PANT_MALE DB 10,13,' 3    PANT (MALE)               210 INR $'

M_SHOES DB 10,13,' 4    MALE SHOES                350 INR $'

CS_FEMALE DB 10,13,' 5    CASUAL SHIRT(FEMALE)      140 INR $'

PANT_FEMALE DB 10,13,' 6    PANT (FEMALE)             220 INR $'

F_SHOES DB 10,13,' 7    FEMALE SHOES              310 INR $'

PANJABI DB 10,13,' 8    PANJABI                   180 INR $'

KURTI DB 10,13,' 9    KURTI                     225 INR $'
